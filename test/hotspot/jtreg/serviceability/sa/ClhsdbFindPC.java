...
public class ClhsdbFindPC {
    ...
    private static void testFindPC(boolean withXcomp, boolean withCore) throws Exception {
        try {
            ...
            // Run findpc on a Method*. We can find one in the jstack output.
            ...
            // The tid for a thread is it's JavaThread* This is testing the
            // PointerFinder support for all C++ types other than MetaData types.
            ...
            if (Platform.isWindows()) {
                expStrMap.put(cmdStr, List.of("jvm!JavaThread::`vftable\'"));
